...
CREATE PROCEDURE IF NOT EXISTS UpdatePayment(
    ...
    IN p_order_id INT,
    IN p_amount DECIMAL(10, 2),
    IN p_payment_date DATETIME -- Nuevo parámetro para la fecha del pago
)
BEGIN
    DECLARE total_paid DECIMAL(10, 2);
    DECLARE total_order DECIMAL(10, 2);

    -- Actualizar el pago existente, incluyendo la fecha
    UPDATE payment
    SET order_id = p_order_id,
        amount = p_amount,
        payment_date = p_payment_date -- Utiliza el nuevo parámetro para la fecha del pago
